...
```{r}
nombre_individus_sup_5<-function(dataframe){
compteur_individu_sepal_sup_5=0
for (length in dataframe$Sepal.Length) {
  ...
  return(compteur_individu_sepal_sup_5)
}

nombre_individus_sup_5(iris)


### fonction qui crée un tableau contenant la moyenne pour chaque variable d'une espèce

moyenne_espece <- function(iris){
